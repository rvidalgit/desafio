...
const val PLANET_SIZE_X = 5
const val SPACE_PROBE_ID_1 = 1L
const val SPACE_PROBE_ID_2 = 2L
const val SPACE_PROBE_POSITION_1 = 1
const val SPACE_PROBE_POSITION_2 = 2
